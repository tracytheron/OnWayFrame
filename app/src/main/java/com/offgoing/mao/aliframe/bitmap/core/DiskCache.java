...
//    	Log.i("init", "mDiscCacheDir（磁盘缓存路径） = " + path + ", maxEntries（缓存图片数） = " + maxEntries + ", maxBytes（磁盘缓存大小） = " + maxBytes);
    ...
    public void delete(){
        deleteFileSilently(mDiscCacheDir + ".idx");
        deleteFileSilently(mDiscCacheDir + ".0");
        deleteFileSilently(mDiscCacheDir + ".1");
    }
